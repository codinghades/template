...
const features = [
  ...
  },
  {
    ...
    description:
      "Generate comprehensive test suites automatically. Our AI analyzes your code and create unit tests, integration tests, and edge case coverage.",
  ...
  },
  {
    ...
    description:
      "Identify and fix bugs before they reach production. AI-powered error detection and resolution suggestions helps you debug faster.",
              ...
              <div className="flex-1 w-full">
                <div className="relative group">
                  <div
                    ...
                    rounded-xl sm:rounded-2xl transition-xl duration-500
                    "
                  />
                  <div
